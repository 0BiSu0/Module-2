...
public class AuthenticPhonee extends Phone{
    private int granteeByYear;
    private String granteeByCode;

    public AuthenticPhonee(int id, String name, Double price, String manufacturer, int granteeByYear, String granteeByCode) {
