package PhoneManager.Service;

import PhoneManager.Model.AuthenticPhonee;
import PhoneManager.util.FileHelper;
...
public class PhoneService {
    ...
    private static final String PATH = "src/PhoneManager/data/phone.csv";
    ...
    private List<Phone> mapToPhones() {
        ...
        for (int i = 0; i < lines.size(); i++) {
            ...
            if(tmp[tmp.length - 1].equals("0")){
                ...
                String code = tmp[5];
                AuthenticPhonee authentic = new AuthenticPhonee(id, name,price, manufacturer, granteeByYear, code);
